...
2) Frontend React application (located in the separate repository).
...
1) Download this Spring Boot application.
...
1) Download the React application (located in the separate repository).
2) Unpack the zip file to a desired location.
3) Open the application directory in your IDE (IntelliJ IDEA is preferred).
